    ...
    >
        ...
        <h2 className="mb-2 md:mb-4 max-w-md text-5xl font-bold text-white leading-tight md:text-7xl">
          ...
          <span className="text-secondary">conteúdo?</span>
                    ...
                    <p className="text-gray-400 mb-8 max-w-md md:max-w-xl">Entre em contato conosco hoje mesmo e descubra como podemos ajudar sua empresa a alcançar novos patamares de sucesso online.</p>  
                <ButtonWhatsApp />
            </div>
        </section>
    )
